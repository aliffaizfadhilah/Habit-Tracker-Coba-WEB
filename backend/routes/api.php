...
Route::prefix('auth')->group(function () {
    ...
    Route::post('/google/set-cookie', [AuthController::class, 'setGoogleCookie']);
...
Route::middleware('jwt.auth')->group(function () {
    ...
    Route::post('/habits/{id}/check-today', [ActivityLogController::class, 'checkToday']);

    Route::get('/streak',       [StreakController::class, 'index']);
    Route::get('/streak/{id}',  [StreakController::class, 'show']);
    ...
    Route::post('/profile/change-password/request',    [ProfileController::class, 'requestChangePassword']);
    Route::post('/profile/change-password/verify',     [ProfileController::class, 'verifyChangePasswordOtp']);
    Route::post('/profile/change-password/reset',      [ProfileController::class, 'changePassword']);
});
