// ─── Register Page ─────────────────────────────────────────────────────────────
// Lokasi  : frontend/src/pages/auth/Register.tsx
// Perubahan:
//  - Hapus Google register button & Divider (Google OAuth dihapus)
//  - Registrasi sukses → langsung /dashboard (tidak ada OTP)
...
export default function Register() {
  const {
    form, errors, loading, showPass, setShowPass, handleChange, handleSubmit,
  } = useRegister()
  ...
  return (
    <AuthLayout
      ...
      subtitle="Mulai perjalanan habitmu hari ini, gratis"
    >
